...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in fade-in duration-500 space-y-8">
      ...
      {/* 🇮🇳 Indian NBFC Underwriting Architecture Banner (4 Ground Realities) */}
      <div className="bg-[#111] border border-[#333] rounded-2xl p-6 space-y-4 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#222] pb-3.5">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold uppercase tracking-wider text-amber-400">Indian NBFC Underwriting Architecture</span>
              <span className="text-[10px] font-mono bg-[#1a1a1a] text-gray-300 border border-[#333] px-2 py-0.5 rounded">
                Bajaj Finance • Tata Capital • Shriram • Navi • KreditBee
              </span>
            </div>
            <h2 className="text-base font-semibold text-white tracking-tight mt-1">
              Production Underwriting Ground Realities & Core Modules
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 pt-1">
          ...
          <Link
            to="/applications/new"
            className="bg-[#181818] hover:bg-[#202020] border border-[#2a2a2a] hover:border-[#444] p-4 rounded-xl space-y-2 transition-all group"
          >
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase text-amber-400 font-mono">Module 1</span>
              <span className="text-[10px] text-emerald-400 font-bold bg-emerald-500/10 px-2 py-0.5 rounded">Active Engine</span>
            </div>
            <h3 className="text-xs font-bold text-white group-hover:text-amber-300 transition-colors">
              NTC / Thin-File Borrowers
            </h3>
            <p className="text-[11px] text-gray-400 leading-snug">
              CIBIL: -1 alternate cashflow underwriting via UPI velocity & BBPS utility history with ₹1.5L Safe Cap.
            </p>
          </Link>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase text-yellow-400 font-mono">Module 2</span>
              <span className="text-[10px] text-yellow-300 font-bold bg-yellow-500/10 px-2 py-0.5 rounded">Exception Queue</span>
            </div>
            <h3 className="text-xs font-bold text-white group-hover:text-yellow-300 transition-colors">
              FOIR & Asset Offsets
            </h3>
            <p className="text-[11px] text-gray-400 leading-snug">
              High-income earners with FOIR &gt; 50% approved via mutual funds & bank liquidity buffer mitigations.
            </p>
          </Link>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase text-gray-400 font-mono">Module 3</span>
              <span className="text-[10px] text-gray-300 font-bold bg-white/10 px-2 py-0.5 rounded">Bureau Gateway</span>
            </div>
            <h3 className="text-xs font-bold text-white group-hover:text-gray-200 transition-colors">
              Bureau Telemetry & Fraud Knockout
            </h3>
            <p className="text-[11px] text-gray-400 leading-snug">
              NSDL PAN & UIDAI Aadhaar real-time pull with 0-DPD and write-off deterministic knockout.
            </p>
          </Link>
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase text-gray-400 font-mono">Module 4</span>
              <span className="text-[10px] text-gray-300 font-bold bg-white/10 px-2 py-0.5 rounded">BRE Studio</span>
            </div>
            <h3 className="text-xs font-bold text-white group-hover:text-gray-200 transition-colors">
              Policy Agility & Versioning
            </h3>
            <p className="text-[11px] text-gray-400 leading-snug">
              Zero-code policy threshold adjustments with version tracking, simulation & immutable audit log.
            </p>
          </Link>
        </div>
      </div>
